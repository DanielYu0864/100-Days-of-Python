...
class Snake:
    ...
    def add_segment(self, position):  # step 1 Create a snake body
    ...
    def extend(self):  # step 7 Detect collision with tail
        """
            extend 1 segment in the end of segment[]
        """
        self.add_segment(self.segments[-1].pos())  # .pos() == turtle.position()
