...
def make_coffee(drink, coffee_ingredients):
    for item in coffee_ingredients:
...
def coffee_machine():
    ...
    user_choice = ask_user_coffee()
    if user_choice == 'off':
        print('Bye than')
        return
    drink = MENU[user_choice]
    if check_resources(drink['ingredients']) == False:
...
#       Coffee: 76g
#       Money: $2.5
#       b. Once all resources have been de
